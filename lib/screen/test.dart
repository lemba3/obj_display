...
class _MyAppState extends State<WebGlLoaderObjLtl> {
  ...
  rotateInY(double angle) {
    object.rotateY(angle);
    setState(() {});
  }

  rotateInX(double angle) {
    object.rotateX(angle);
    setState(() {});
  }

  rotateInZ(double angle) {
  ...
  initPage() async {
    ...
    mtlLoader.setPath('assets/axe/');
    var materials = await mtlLoader.loadAsync('axe.mtl');
    await materials.preload();

    var loader = three_jsm.OBJLoader(null);
    loader.setMaterials(materials);
    object = await loader.loadAsync('assets/axe/axe.obj');
